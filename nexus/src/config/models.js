...
export const IMAGE_MODELS = [
    ...
    },
    {
        ...
        timeout: 240000,
        tips: '支持文生图/图文生图/多图融合；参考图通过 image 字段传入（单张 URL 或 URL 数组）。size 支持 1K/2K/4K 或像素宽高。',
        requiresPrompt: false,
        supportsReferenceImages: true,
        maxRefImages: 9,
        qualities: [
    ...
    },
    {
        ...
        format: 'doubao-seedream',
        timeout: 240000,
        tips: '支持文生图/图生图/多图生图；参考图通过 image 字段传入（单张 URL 或 URL 数组）。size 支持 1K/2K/4K 或像素宽高。',
        requiresPrompt: false,
        supportsReferenceImages: true,
        maxRefImages: 9,
        qualities: [
    ...
    },
    {
        ...
        tips: 'Kling Omni-Image：提示词必填（≤2500字符）；可选多张参考图 image_list；resolution: 1k/2k；n: 1-9；aspect_ratio 含 auto 自动比例。',
        requiresPrompt: true,
        supportsReferenceImages: true,
        maxRefImages: 9,
...
export const VIDEO_MODELS = [
    ...
    },
    {
        ...
        format: 'kling-video',
        maxImages: 2,
        tips: 'model_name=kling-v2-6，mode=pro，sound=on；支持 5/10 秒。支持首帧，不支持尾帧（有音频时尾帧不可用）。',
        requiresPrompt: false,
        supportsFirstFrame: true,
    ...
    },
    {
        ...
        maxImages: 7,
        tips: 'Vidu Q3 Pro；支持参考图（最多7张）+尾帧；时长1-10秒；720P/1080P；支持音频生成。',
        requiresPrompt: true,
        supportsFirstFrame: true,
        supportsLastFrame: true,
        supportsReferenceImages: true,
    ...
    },
    {
        ...
        format: 'tencent-aigc-video',
        maxImages: 7,
        tips: 'Vidu Q2 Pro；支持参考图（最多7张）+尾帧；时长1-10秒；720P/1080P；支持音频生成。',
        requiresPrompt: true,
        supportsFirstFrame: true,
        supportsLastFrame: true,
        supportsReferenceImages: true,
