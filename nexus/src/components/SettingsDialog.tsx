        ...
        <div className="space-y-6 px-5 py-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded-md border border-[var(--border-color)] bg-[var(--bg-tertiary)] px-3 py-2 text-sm text-[var(--text-primary)] outline-none focus:ring-2 focus:ring-[rgb(var(--accent-rgb)/0.35)]"
            >
